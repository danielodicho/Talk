...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF7643A7);
  late Color secondary = const Color(0xFFCAADF4);
  late Color tertiary = const Color(0xFF99E9DF);
  late Color alternate = const Color(0xFFE0E3E7);
  late Color primaryText = const Color(0xFF14181B);
  late Color secondaryText = const Color(0xFF57636C);
  late Color primaryBackground = const Color(0xFFF1F4F8);
  late Color secondaryBackground = const Color(0xFFEDE9FB);
  ...
  late Color lineColor = Color(0x00FFFFFF);
}
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color lineColor = Color(0xFFEDD822);
}
